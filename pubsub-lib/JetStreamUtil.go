...
const (
	...
	DEVTRON_CHART_INSTALL_STATUS_TOPIC   string = "DEVTRON-CHART-INSTALL-STATUS-TOPIC"
	DEVTRON_CHART_INSTALL_STATUS_GROUP   string = "DEVTRON-CHART-INSTALL-STATUS-GROUP"
...
var natsTopicMapping = map[string]NatsTopic{
	...
	DEVTRON_CHART_INSTALL_STATUS_TOPIC: {topicName: DEVTRON_CHART_INSTALL_STATUS_TOPIC, streamName: ORCHESTRATOR_STREAM, queueName: DEVTRON_CHART_INSTALL_STATUS_GROUP, consumerName: DEVTRON_CHART_INSTALL_STATUS_DURABLE},
}
