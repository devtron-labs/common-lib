...
*/
//todo have to add test case for hour and min
func TestGetDurationAndGetCron(t *testing.T) {
	...
	for i, test := range tests {
		...
		//windowStart, windowEnd, isBetween := ScheduleParser.GetScheduleSpec()
